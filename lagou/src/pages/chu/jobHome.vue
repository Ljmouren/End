	...
	<div class="jobHome">
		...
		<div class="middle">
			...
			<div class="middle-2">
				...
				<div class="right">
					<a class="tu1" href="#"><i class="fa fa-angle-left fa-lg"></i></a><span>1/30</span>
					<a class="tu2" href="#"><i class="fa fa-angle-right fa-lg"></i></a>
			...
			<div class="middle-5">
				<div class="middle-5-1">
					...
					<el-pagination background :current-page.sync="currentPage" :page-size="pageSize" layout="prev, pager, next" :total="jobArr.length">
					</el-pagination>
				</div>
			</div>
